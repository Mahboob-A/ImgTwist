...
from core_apps.users.views import UserRegistrationAPI, UserLoginAPI, UserLogOutAPIView, UserTokenObtainPairView


urlpatterns = [
    path("signup/", UserRegistrationAPI.as_view(), name="api_user_signup",),
